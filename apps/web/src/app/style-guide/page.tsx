...
// Internal-only reference page for the design system (WP3/WP4) — not part
// of the Phase One sitemap, so it's excluded from search indexing. Header/
// Footer/SkipLink/ConsentBanner aren't rendered here: the root layout
// (WP4) already wraps every route with them.
...
const demoSections: PageSection[] = [
  ...
  },
  {
    ...
    intro: "This is the real ContactForm component, rendered via PageSections.",
  },
  ...
  return (
    <div className={styles.page}>
      <Container>
        ...
        <p>
          Internal reference for the design system — every pattern, rendered
      ...
      <div className={styles.section}>
        <Container>
          ...
          <p>
            Includes the real <code>ContactForm</code> (via{" "}
            <code>formEmbedBlock</code>); the last block (
            <code>teamGridBlock</code>) intentionally renders nothing — see{" "}
            <code>PageSections</code>&rsquo;s doc comment.
          </p>
        </Container>
